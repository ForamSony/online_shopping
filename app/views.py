...
def mobile(request,data = None):
 if data == None :
  mobiles = Product.objects.filter(category='M')
 elif data == 'Samsung' or data == 'Redmi'or data == 'Iphone' or data == 'Vivo':
  mobiles = Product.objects.filter(category='M').filter(brand=data)
 elif data == 'below':
  mobiles = Product.objects.filter(discount_price__lt=10000).filter(category='M')
 elif data == 'above':
  mobiles = Product.objects.filter(discount_price__gt=10000).filter(category='M')
